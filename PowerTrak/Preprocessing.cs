    ...
    internal class Preprocessing {
        internal static void FilterFrames(Mat frame, Image<Gray, byte>[] hueMasks, int i, string plateColour) {
            ...
            try {
                ...
                SmoothFrames(hueMask, hueMask, plateColour);
                ...
                SmoothFrames(saturationMask, saturationMask, plateColour);
                ...
                SmoothFrames(valueMask, valueMask, plateColour);
        ...
        internal static void SmoothFrames(Image<Gray, byte> inputMask, Image<Gray, byte> outputMask, string plateColour) {
            ...
            MorphOp morphOp = MorphOp.Close;
            if (plateColour == "yellow") { morphOp = MorphOp.Erode; }
            CvInvoke.MorphologyEx(inputMask, outputMask, morphOp, Mat.Ones(7, 3, DepthType.Cv8U, 1),
        ...
        private static int[] GetGrayScales(string colour) {
            ...
            switch(colour) {
                ...
                case "green": grayValues = new int[] {30, 90, 50, 255, 50, 255}; return grayValues;
            }
            return new int[6];
        }
    }
